package net.mcreator.projecthorsedimension.world.features;
...
import net.mcreator.projecthorsedimension.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, ProjectHorsedimensionMod.MODID);
