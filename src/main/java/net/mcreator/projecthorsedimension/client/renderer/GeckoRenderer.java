...
public class GeckoRenderer extends HumanoidMobRenderer<GeckoEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	...
	@Override
	public void extractRenderState(GeckoEntity entity, HumanoidRenderState state, float partialTicks) {
