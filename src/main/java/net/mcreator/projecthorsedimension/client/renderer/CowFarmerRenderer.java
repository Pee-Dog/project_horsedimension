...
public class CowFarmerRenderer extends HumanoidMobRenderer<CowFarmerEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private CowFarmerEntity entity = null;

	public CowFarmerRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(CowFarmerEntity entity, HumanoidRenderState state, float partialTicks) {
