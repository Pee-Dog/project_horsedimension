...
public class PeajakRenderer extends HumanoidMobRenderer<PeajakEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private PeajakEntity entity = null;

	public PeajakRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(PeajakEntity entity, HumanoidRenderState state, float partialTicks) {
