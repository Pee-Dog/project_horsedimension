...
public class PeeramidRenderer extends HumanoidMobRenderer<PeeramidEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private PeeramidEntity entity = null;

	public PeeramidRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(PeeramidEntity entity, HumanoidRenderState state, float partialTicks) {
