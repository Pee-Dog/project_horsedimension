...
public class CricketentityRenderer extends HumanoidMobRenderer<CricketentityEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private CricketentityEntity entity = null;

	public CricketentityRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(CricketentityEntity entity, HumanoidRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends HumanoidModel<HumanoidRenderState> {
		...
		public void setEntity(CricketentityEntity entity) {
			this.entity = entity;
		}
