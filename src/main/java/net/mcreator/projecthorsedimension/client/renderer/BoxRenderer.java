...
public class BoxRenderer extends HumanoidMobRenderer<BoxEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private BoxEntity entity = null;
	...
	@Override
	public void extractRenderState(BoxEntity entity, HumanoidRenderState state, float partialTicks) {
