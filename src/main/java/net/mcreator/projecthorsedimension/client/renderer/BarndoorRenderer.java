...
public class BarndoorRenderer extends HumanoidMobRenderer<BarndoorEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private BarndoorEntity entity = null;

	public BarndoorRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(BarndoorEntity entity, HumanoidRenderState state, float partialTicks) {
