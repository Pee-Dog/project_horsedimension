...
public class GibentityRenderer extends HumanoidMobRenderer<GibentityEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private GibentityEntity entity = null;

	public GibentityRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(GibentityEntity entity, HumanoidRenderState state, float partialTicks) {
