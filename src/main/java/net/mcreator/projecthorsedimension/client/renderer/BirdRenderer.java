...
public class BirdRenderer extends HumanoidMobRenderer<BirdEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private BirdEntity entity = null;
	...
	@Override
	public void extractRenderState(BirdEntity entity, HumanoidRenderState state, float partialTicks) {
