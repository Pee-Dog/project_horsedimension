...
public class RatRenderer extends HumanoidMobRenderer<RatEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	...
	@Override
	public void extractRenderState(RatEntity entity, HumanoidRenderState state, float partialTicks) {
