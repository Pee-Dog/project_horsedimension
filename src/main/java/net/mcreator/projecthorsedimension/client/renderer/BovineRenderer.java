...
public class BovineRenderer extends HumanoidMobRenderer<BovineEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private BovineEntity entity = null;

	public BovineRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(BovineEntity entity, HumanoidRenderState state, float partialTicks) {
