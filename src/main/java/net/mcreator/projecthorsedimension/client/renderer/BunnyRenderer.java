...
public class BunnyRenderer extends HumanoidMobRenderer<BunnyEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private BunnyEntity entity = null;
	...
	@Override
	public void extractRenderState(BunnyEntity entity, HumanoidRenderState state, float partialTicks) {
