...
public class Modelbirdwings extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("project_horsedimension", "modelbirdwings"), "main");
	public final ModelPart wingus;
	public final ModelPart left_wing;
	public final ModelPart right_wing;
	public final ModelPart empty;

	public Modelbirdwings(ModelPart root) {
		super(root);
