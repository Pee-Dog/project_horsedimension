...
import net.mcreator.projecthorsedimension.procedures.CowFarmerOnEntityTickUpdateProcedure;
...
public class CowHeadEntity extends PathfinderMob {
	public CowHeadEntity(EntityType<CowHeadEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ProjectHorsedimensionModItems.COWHEADITEM.get()));
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			serverPlayer.openMenu(new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Cow Head");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(CowHeadEntity.this.getId());
	...
	public void baseTick() {
		super.baseTick();
		CowFarmerOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
