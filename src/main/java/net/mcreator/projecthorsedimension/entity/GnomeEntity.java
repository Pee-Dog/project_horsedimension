...
public class GnomeEntity extends PathfinderMob {
	public GnomeEntity(EntityType<GnomeEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ProjectHorsedimensionModItems.GNOMEITEM.get()));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(ProjectHorsedimensionModEntities.GNOME.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
