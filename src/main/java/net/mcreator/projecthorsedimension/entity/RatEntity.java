...
public class RatEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_color = SynchedEntityData.defineId(RatEntity.class, EntityDataSerializers.INT);
	...
	public RatEntity(EntityType<RatEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ProjectHorsedimensionModItems.RATITEM.get()));
	}
